...
const CommercialDistrictTimeSales = ({ commercialDistrictTimeSales, storeInfoRedux }) => {
    ...
    // 유효한 데이터가 있는지 확인
    const hasValidData = timeValues.some(value => value > 0);
        ...
        <div className="bg-white p-4 rounded-lg shadow-md space-y-6">
            <div className="">
                <p className="text-lg font-bold text-opacity-80">
                    {sub_district_name} '{biz_detail_category_rep_name}' 업종 시간대별 매출 평균 <span className='text-xs font-normal text-black text-opacity-70'>{formatDate(nice_biz_map_data_ref_date)} 기준 자료</span></p>
