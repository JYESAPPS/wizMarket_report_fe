...
const LocInfoAvgJscore = ({ locInfoAvgJscore, storeInfoRedux }) => {
    ...
    return (
        <div className='p-4 bg-[#0D161F] rounded-md tracking-tight shadow-md shadow-black-500'>
            <div className="py-2">
                <p className='text-white text-4xl pb-1 font-semibold'>입지 점수 : <span className='text-[#5BAB84] text-4xl font-extrabold'>{locInfoAvgJscore.loc_info_j_score_average}p</span></p>
