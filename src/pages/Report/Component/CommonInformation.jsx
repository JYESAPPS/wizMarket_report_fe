...
const CommonInformation = ({ commonReport }) => {
    ...
    return (
        <div className="bg-white p-4 rounded-lg tracking-tight shadow-md shadow-black-500">
            <div className="commonReport-item">
                <div className="pb-2">
                    <p className="pb-4 font-bold">{commonReport.title}</p>
                    <p className="text-lg break-words whitespace-pre-wrap" dangerouslySetInnerHTML={{ __html: convertUrlsToLinks(commonReport.content) }} />
                </div>
